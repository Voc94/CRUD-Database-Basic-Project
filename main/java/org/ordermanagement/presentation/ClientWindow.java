    ...
    public ClientWindow() {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Client client = new Client(0, numeField.getText(), prenumeField.getText(), adresaField.getText(), Integer.parseInt(varstaField.getText()));
        ...
        editButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Client client = new Client(Integer.parseInt(idField.getText()), numeField.getText(), prenumeField.getText(), adresaField.getText(), Integer.parseInt(varstaField.getText()));
        ...
        Object[] columnsName = new Object[] {"ID", "Nume", "Prenume", "Adresa", "Varsta"};
